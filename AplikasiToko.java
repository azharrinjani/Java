...
public class AplikasiToko extends JFrame {
    ...
    final static String StringConnection="jdbc:mysql://localhost:3306/aplikasi_toko?user=root&password=";
                ...
                if (!JDBC_Err) {
                    ...
                    try {
                        ...
                        if (rset.getRow()>0) {
                            ...
                            System.out.println(IDUserAktif);
                            System.out.println(TxtNoNotaJual.getText());
                            System.out.println(Tanggal);
                            System.out.println(TxtKodeCustomerJual.getText());
